          ...
          <section className='fold fold--filled fold--media-bleed-right'>
            <div className='inner'>
              ...
              <div className='fold__copy'>
                ...
                <div className='fold__body'>
                  <p>
We aggregate physical air quality data from public real-time data sources provided by government, research-grade and other sources. These awesome groups do the hard work of measuring these data and publicly sharing them, and our community makes them more universally-accessible to both humans and machines. We aggregate PM2.5, PM10, ozone (O3), sulfur dioxide (SO2), nitrogen dioxide (NO2), carbon monoxide (CO), and black carbon (BC) from real-time government and research grade sources. Please note: (1) We do not validate or transform the data from their originating sources. (2) Real-time data, by their nature, often have not undergone quality assurance or control processes by their originating sources. (3) Please contact originating sources for more detailed information not provided on this platform.</p>
                </div>
