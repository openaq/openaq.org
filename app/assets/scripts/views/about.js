          ...
          <section className='fold fold--stacked' id='about-fold-main-board'>
            <div className='inner'>
              <header className='fold__header'>
                ...
                <div className='fold__teaser prose prose--responsive'>
                  <p>Our team is passionate about fighting air inequality with open data. If you would like to make an inquiry to the team, please reach out to <a href='mailto:info@openaq.org'>info@openaq.org</a></p>
                </div>
              </header>
