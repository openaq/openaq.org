            ...
            <div className='inner'>
              ...
              <div className='fold__body'>
                <ul className='sponsors__list'>
                  ...
                  <li><a className='sponsors__item' target='_blank' href='http://www.fz-juelich.de/portal/DE/Home/home_node.html/'><img src='assets/graphics/content/sponsors/julich.jpg' alt='View sponsor website'/></a></li>
