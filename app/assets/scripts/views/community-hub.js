    ...
    return (
      <section className="inpage">
        ...
        <div className="inpage__body">
            ...
            <div className="inner">
              <header className="fold__header">
                <h1 className="fold__title">
                  {widont(
                    'Scientists, software developers, educators, journalists, analysts, activists, lovers of open environmental data from around the globe working for one purpose.'
                  )}
                </h1>
              </header>
            </div>
          ...
          <section
            className="fold fold--semi-light"
            id="community-fold-participate"
          >
            <div className="inner">
              <header className="fold__header">
                    ...
                    <div className="card__contents">
                      ...
                      <div className="card__body">
                        <div className="card__prose prose prose--responsive">
                          <p>
                            Get inspired by the ways our Community are using
                            data to fight air inequality.
                          </p>
                        </div>
                      </div>
                  ...
                  <article className="card card--participate">
                    <div className="card__contents">
                      ...
                      <div className="card__body">
                        <div className="card__prose prose prose--responsive">
                          <p>
                            OpenAQ convenes local communities to build new
                            collaborations and projects around open data.
                          </p>
                        </div>
                      </div>
                      <footer className="card__footer">
                  ...
                  <article className="card card--participate">
                    <div className="card__contents">
                      ...
                      <div className="card__body">
                        <div className="card__prose prose prose--responsive">
                          <p>
                            Access free, open-source community tools created by
                  ...
                  <article className="card card--participate">
                    <div className="card__contents">
                      ...
                      <div className="card__body">
                        <div className="card__prose prose prose--responsive">
                          <p>
                            Join other official organizations and governments
                            around the world and share your air quality data.
                          </p>
                        </div>
                      </div>
                      <footer className="card__footer">
                        <a
                          ...
                          title="View more"
                        >
                          <span>Become a data source</span>
                        </a>
                      </footer>
                    </div>
                  </article>
