              ...
              <ul className="card__footer-actions">
                <li>
                  <a
                    ...
                    title={`Download data for ${o.name}`}
                    onClick={this.onDownloadClick.bind(null, o.code)}
                  >
                    Download
                  </a>
                </li>
    ...
    return (
      <section className="inpage">
            ...
            <div className="inpage__headline">
              ...
              <div className="inpage__introduction">
                <p>
                  ...
                  {this.props.countries.length} different countries and are
                  always seeking to add more. We aggregate PM2.5, PM10, ozone
                  (O3), sulfur dioxide (SO2), nitrogen dioxide (NO2), carbon
                  monoxide (CO), and black carbon (BC) from real-time government
                  and research grade sources. If you cannot find the location
        ...
        <div className="inpage__body">
          <div className="fold">
            <div className="inner">
              <ol className="country-list">{this.renderCountryList()}</ol>
            </div>
          </div>
        </div>
      </section>
