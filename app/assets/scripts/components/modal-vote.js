        ...
        <ModalHeader>
          <div className="modal__headline">
            <h1 className="modal__title">
              The Open Science Prize Vote ends on Friday, Jan 6! Have you voted?
            </h1>
          </div>
        </ModalHeader>
        <ModalBody>
          <div className="prose">
            <p className="modal__description">
              Hello, OpenAQ Community! We hope this find you well and building
              all kinds of cool stuff with open air quality data.
            </p>
            <p className="modal__description">
            ...
            <p className="modal__description">
              ...
              This message will disappear after January 6th, when the
              competition closes.
            </p>
            <form className="form form-vote">
              <div className="form__actions">
                ...
                <a
                  href="http://event.capconcorp.com/wp/osp/vote-now/"
                  onClick={this.props.onModalClose}
