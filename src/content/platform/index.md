...
OpenAQ searches and gathers data sources to extract and store data. OpenAQ
provides fine grained physical measurements, not aggregated values such as AQIs
(Air Quality Indexes).

![openaq platform diagram](@assets/images/platform_diagram.png)
...
For programmatic users, the best way to access data on the OpenAQ platform is
through the OpenAQ REST API. The API allows programmatic and queryable access to
the OpenAQ database.

![openaq documentation](@assets/images/docs_screenshot.png)
